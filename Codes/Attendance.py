...
class Attendance(Window):
    ...
    def search(self):
        ...
        self.form.attendanceTable.setColumnCount(5)
        ...
        for i, elem in enumerate(result):
            ...
            points = QTableWidgetItem(str(elem[4]))
            ...
            self.form.attendanceTable.setItem(i, 3, points)
            self.form.attendanceTable.setItem(i, 4, name)
